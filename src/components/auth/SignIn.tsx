...
const SignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mock validation - this would be replaced with actual auth
      if (email === "user@example.com" && password === "password") {
        // Store user data locally - this would use more secure methods in a real app
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 p-4 py-12">
